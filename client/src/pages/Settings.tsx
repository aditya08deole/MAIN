...
import { getUserPreferences, updateUserPreferences, type UserPreferences } from '../services/settings';
            ...
            <div className="apple-glass-card rounded-2xl shadow-sm border border-slate-200 overflow-hidden divide-y divide-slate-100">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-semibold text-slate-700">Email Alerts</div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-slate-500">Receive critical alerts via SMS.</div>
                                </div>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                ...
                <div className="p-6 apple-glass-inner flex justify-end">
                    <button
                        onClick={handleSave}
                        disabled={loading}
                        className={`flex items-center gap-2 px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg btn-liquid-glass ${saved ? 'btn-liquid-glass-green' : 'btn-liquid-glass-slate'}`}
                    >
